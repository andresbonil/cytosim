...
template <>
void Lattice<uint8_t>::write_data(Outputter& out, site_t inf, site_t sup) const
{
    out.writeUInt16(0);
    out.writeUInt8(0);
    out.writeUInt8(1);
...
/// write data within [inf, sup[ to file
template <>
void Lattice<uint16_t>::write_data(Outputter& out, site_t inf, site_t sup) const
{
    out.writeUInt16(0);
    out.writeUInt8(0);
    out.writeUInt8(2);
...
/// write data within [inf, sup[ to file
template <>
void Lattice<uint32_t>::write_data(Outputter& out, site_t inf, site_t sup) const
{
    out.writeUInt16(0);
    out.writeUInt8(0);
    out.writeUInt8(4);
